...
func TestParseColourStrings(t *testing.T) {
	t.Run("all succeeding", func(t *testing.T) {
		colour, props, err := ParseColourStrings(ColourStrings{R: "1", G: "2", B: "3", A: "4"}, "", map[string][]string{})
	...
	t.Run("all failing", func(t *testing.T) {
		colour, props, err := ParseColourStrings(ColourStrings{R: "a", G: "b", B: "c", A: "d"}, "", map[string][]string{})
